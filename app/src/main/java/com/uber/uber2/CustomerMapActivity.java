                ...
                if (requestBol){
                    ...
                    geoFire.setLocation(userId, new GeoLocation(mLastLocation.getLatitude(), mLastLocation.getLongitude()), new GeoFire.CompletionListener() {
                        ...
                        public void onComplete(String key, DatabaseError error) {
                            Toast.makeText(CustomerMapActivity.this, "Completed", Toast.LENGTH_SHORT).show();
                        }
                    });
...
//        });
        ...
        if (!Places.isInitialized()) {
           // Places.initialize(getApplicationContext(), "AIzaSyC2ZRiKDkIKBaZWDPduZhgqCn4zVkIespY", Locale.US);
            // Initialize Places.
            Places.initialize(getApplicationContext(), "AIzaSyC2ZRiKDkIKBaZWDPduZhgqCn4zVkIespY");
        }
...
//                new LatLng( -1.292100, 36.821900)));
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(@NonNull Status status) {
                Log.i(String.valueOf(CustomerMapActivity.this), "An error occurred: " + status);
            }
        });
        ...
        driverLocation.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists() ){
                    ...
                    Toast.makeText(CustomerMapActivity.this, "No Drivers found ", Toast.LENGTH_SHORT).show();
                    requestBol = false;
                    pickupLocation = null;
                    pickupMarker = null;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists() ){
                    geoFire.removeLocation(userId, new GeoFire.CompletionListener() {
                        @Override
                        public void onComplete(String key, DatabaseError error) {
                            Toast.makeText(CustomerMapActivity.this, "sucessfully removed "+ userId, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
